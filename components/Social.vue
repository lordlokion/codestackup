      ...
      <div class="flex flex-wrap gap-4">
        <div class="mx-auto">
          <div class="flex flex-wrap gap-4 ">
            <!-- Facebook Icon -->
            <a
              class="border-rhino-200 flex h-12 w-12 items-center bg-purple-200 justify-center rounded-full border text-gray-600 transition duration-200 hover:border-transparent hover:bg-purple-600 hover:text-white"
              href="#"
            >
              <svg
